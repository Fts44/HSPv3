                        ...
                        <tr>
                            ...
                            @else
                                <td>
                                    ...
                                    <a class="btn btn-danger btn-sm" href="" onclick="return delete_confirmation('{{ $item->iet_type }}','{{ route('AdminConfigurationDeleteEquipmentType', ['id' => $item->iet_id]) }}');"><i class="bi bi-eraser"></i></a>
                                </td>
                            @endif
                        </tr>
                    @endforeach
