    ...
    <section class="section profile">
        <div class="row">
            <div class="col-lg-12">
                <div class="card mb-3">
                    <div class="card-body">
                        <form action="{{ route('UpdatePatientVaccinationInsurance') }}" method="POST">
                            @csrf
                            <div class="row pt-4">
                                ...
                                @foreach($user_dose_details as $dose)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-danger" onclick="delete_dosage('{{ $dose->vdd_dose_number }}', '{{ route('DeletePatientVaccinationDoseDetails', ['id' => $dose->vdd_id]) }}')"><i class="bi bi-eraser"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
    ...
    <div class="modal fade" id="dosage" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modal_title" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="dosage_form" action="{{ route('InsertPatientVaccinationDoseDetails') }}" method="POST">
                    @csrf
                    <div class="modal-body mb-3">
                        ...
                        <label for="brand" class="form-control border-0 p-0 mb-2">
                            ...
                            <select class="form-select" name="brand" id="brand">
                                ...
                                <option value="CoronaVac(Sinovac)" {{ (old('brand')=='CoronaVac(Sinovac)') ? 'selected' : '' }}>CoronaVac(Sinovac)</option>
                            </select>
                            <span class="text-danger mt-1">
                                @error('brand')
                                    {{ $message }}
