...
class OTPController extends Controller
{
    ...
    public function compose_mail(Request $request){
        ...
        if($validator->fails()){
            ...
            if($request->msg_type == "register"){
                $msg_body = "Hello!,<br><p>To register/add this email to your account, Please use this One Time Pin (OTP): <b>".$new_otp."</b><br><br>For inquiries Contact: [email of school here]<br><i>***Note: This email is automatically generated by the ARASOF-Health Services. Please do not reply to this email!***</i>";
            }
            else{
